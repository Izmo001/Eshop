...
const SignUp = () => {
  ...
  return (
    <div className= "w-full py-30 min-h-[85vh] bg-[#f1f1f1]">
        <h1 className='text-4xl text-lg  font-semibold font-Poppins'>signUp</h1>
        ...
        <div className='w-full flex justify-center'>
            <div className='md:w-[48px] p-8 bg-white shadow rounded-lg '>
                ...
                <p>
                   Already have an account? <span className='text-[#3489ff] font-semibold'>Create an account</span>
                   <Link href={"/login"} className='text-[#3489ff] font-semibold'>Login</Link>
                </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type="text " placeholder='David Mutinda' className='w-full p-2 border-gray-300 outline-0 rounded mb-1'{...register("name", {
